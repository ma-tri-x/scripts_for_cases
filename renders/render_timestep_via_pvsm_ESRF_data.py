...
def rescale_data_range(view):
    ...
    for i in view.Representations:
        try:
            ...
            print("AttributeError in rescale_data_range")
            pass
...
def render_timestep():
    ...
    parser.add_argument("-p", "--path", help="path e.g. like \"processor0\"", type=str, required=False, default="processor0")
    ...
    parser.add_argument("-r", "--rescale_or_not", help="Rescale the data range? \
                        \"y\" or \"n\"", type=str, required=False, choices=['y','n'], default="y")
    parser.add_argument("-t", "--trim_outfile", help="Trimming the outfile picture? \
                        \"y\" or \"n\"", type=str, required=False, choices=['y','n'], default="n")
