...
# ../dstar_0.2 # broken because of spurious currents
# ../dstar_0.4 # broken because of spurious currents
# dstar_cases=" \
# ../dstar_0.6 \
# ../dstar_0.8 \
# ../dstar_1.0 \
...
for i in $dstar_cases;do
    echo $i
    rm $i/states/inkmap_axisymm*.pvsm*
    ...
    statefile=states/inkmap_axisymm_lagrangianInk_vorticity_withText_for_manual_edit_V4.pvsm
