...
study_cases=" \
../bb020_sp_conv_study_0.015mum_int3cells \
../bb021_sp_conv_study_0.01mum_int3cells \
"
...
tar czvf bb020_bb021_for_Berlin.tar.gz $study_cases
scp bb020_bb021_for_Berlin.tar.gz ma-tri-x@berlin.physik3.uni-goettingen.de:~/2019WiSe2020/foamProjects
