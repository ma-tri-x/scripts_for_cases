...
study_cases=" \
../conv_study_3mum_unbound_boxBubble \
../conv_study_2mum_unbound_boxBubble \
../conv_study_1.35mum_unbound_boxBubble \
../conv_study_1mum_unbound_boxBubble \
../conv_study_0.75mum_unbound_boxBubble \
"
...
for i in $study_cases;do
    ...
    sed -i "s/\"boxBubble\" : \"false\"/\"boxBubble\" : \"true\"/g" conf_dict.json
