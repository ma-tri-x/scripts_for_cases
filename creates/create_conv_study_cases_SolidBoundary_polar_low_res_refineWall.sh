...
# ../conv_study_3mum_SolidBoundary_polar_low_res_refineWall \
# ../conv_study_2mum_SolidBoundary_polar_low_res_refineWall \
# ../conv_study_1.35mum_SolidBoundary_polar_low_res_refineWall \
study_cases=" \
../conv_study_1mum_SolidBoundary_polar_low_res_refineWall \
"
# ../conv_study_0.75mum_SolidBoundary_polar_low_res_refineWall \
